...
class AddressService {
  ...
  Future<List<Customer_Address>> getAddresses() async {
    try {      // Get token from SharedPreferences
      final prefs = await SharedPreferences.getInstance();
      final token = prefs.getString('token') ?? ApiService.token;
  ...
  // Add a new address
  Future<Customer_Address> addAddress(String address, String phoneNumber) async {
    try {
  ...
  Future<Customer_Address> updateAddress(
    ...
    try {
      ...
      final response = await ApiService.put(
        '/user/info/update_customeraddress',
        {
