...
class _AccountScreenState extends State<AccountScreen> {
  ...
  Widget buildInfoTile(String title, String? value, IconData icon, Color primaryColor) {
    return ListTile(
    ...
    if (confirmed == true) {
      ...
      if (success) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text(requestSignIn.errorMessage)),
        );
      }
    }
  }
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Card(
                        ...
                        child: Column(
                          children: [
                            ...
                            buildInfoTile('Email', email, Icons.email_outlined, primaryColor),
                            buildInfoTile('Giới tính', gender, Icons.wc, primaryColor),
                            buildInfoTile('Ngày sinh', dob, Icons.cake_outlined, primaryColor),
                            buildInfoTile('Số điện thoại', phoneNumber, Icons.phone, primaryColor),
                          ],
                        ),
                      ),
                      const SizedBox(height: 20),
                      ...
                      Column(
                        ...
                        children: [
                          ElevatedButton.icon(
                            icon: const Icon(Icons.lock_outline, size: 22, color: Colors.white),
                            label: Text(
                              'Đổi mật khẩu',
                              style: GoogleFonts.montserrat(
                                fontSize: 16,
                          ...
                          ElevatedButton.icon(
                              ...
                              style: ElevatedButton.styleFrom(
                                ...
                                backgroundColor: const Color.fromARGB(255, 2, 150, 102),
                              ),
                              onPressed: () {
