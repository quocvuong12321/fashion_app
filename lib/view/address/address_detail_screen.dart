...
class _AddressDetailsScreenState extends State<AddressDetailsScreen> {
  ...
  String _formatVietnameseAddress(Placemark place) {
    ...
    if (place.country != null && place.country!.isNotEmpty && place.country != "Vietnam") {
  ...
  void _saveAddress() {
    if (_formKey.currentState?.validate() ?? false) {
      ...
      Navigator.pop(context, {
        ...
        'phoneNumber': _phoneNumber?.phoneNumber ?? _phoneController.text.trim(),
      });
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text(widget.addressModel == null ? 'Add New Address' : 'Update Address'),
        elevation: 0,
      ),
      body: Form(
        key: _formKey,
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        _fullAddress.isEmpty ? 'Tap refresh to get current location' : _fullAddress,
