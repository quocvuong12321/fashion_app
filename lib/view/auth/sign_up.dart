          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 6),
                Text('Join us and explore the fashion world!',
...
GestureDetector(
      ...
      validator: (value) {
        ...
        return null;
                ...
                _buildSocialLoginButtons(
                    'Continue with Google', 'assets/Images/google.jpg', () {}),
                SizedBox(height: 13),
                _buildSocialLoginButtons(
                    'Continue with Facebook', 'assets/Images/facebook.jpg', () {}),
                SizedBox(height: 13),
                Padding(
                    ...
                    child: ElevatedButton(
                      onPressed: isLoading
                          ...
                          : () async {
                              ...
                              try {
                                DateTime parsed =
                                    _displayDateFormat.parse(_dobController.text);
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content:
                                      Text(success ? 'Đăng ký thành công!' : errorMessage),
  ...
  Widget _buildSocialLoginButtons(String text, String assetPath, VoidCallback onPressed) {
    return Padding(
      padding: const EdgeInsets.symmetric(vertical: 8.0),
      child: SizedBox(
        width: double.infinity,
