              ...
              children: [
                ...
                GestureDetector(
                  onTap: () async {
                    ...
                    if (pickedDate != null) {
                      _dobController.text =
                          _displayDateFormat.format(pickedDate);
                    }
                  },
                  child: AbsorbPointer(
                    child: TextFormField(
                ...
                SizedBox(height: 13),
                _buildSocialLoginButtons('Continue with Facebook',
                    ...
                    child: ElevatedButton(
                      onPressed: isLoading
                          ...
                          : () async {
                              ...
                              try {
                                DateTime parsed = _displayDateFormat
                                    .parse(_dobController.text);
                                requestSignUp
                                    .setDob(_apiDateFormat.format(parsed));
                              } catch (_) {
