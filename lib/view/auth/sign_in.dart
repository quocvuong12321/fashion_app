...
class _SignInScreenState extends State<SignInScreen> {
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: requestSignIn.isLoading
                      ? null
                      : () {
                          setState(() {
                            _isSubmitted = true;
  ...
  Widget _buildSocialLoginButton(String text, String assetPath, VoidCallback onPressed) {
    return Padding(
